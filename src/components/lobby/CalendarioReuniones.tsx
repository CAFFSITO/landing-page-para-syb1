    ...
    return (
      <button
        ...
        style={{
          position: "relative",
          fontSize: "0.6rem",
          color: esPasado ? "rgba(255,255,255,0.12)" : tiene ? "#FFFFFF" : esHoy ? "#9D5CC0" : "rgba(255,255,255,0.4)",
          textAlign: "center",
          padding: "3px 1px",
          ...
          return (
            <button
              ...
              style={{
                position: "relative",
                fontSize: "0.8rem",
                color: esPasado ? "rgba(255,255,255,0.12)" : tiene ? "#FFFFFF" : esHoy ? "#9D5CC0" : "rgba(255,255,255,0.5)",
                textAlign: "center",
                padding: "8px 4px",
                opacity: esPasado ? 0.12 : 1,
